...
public class Serializer implements Serializable {
    public boolean serialization(House house, String fileName) {
        boolean flag = false;
    ...
    public House deserialization(String fileName) throws InvalidObjectException {
        ...
        try {
            ...
            return (House) istream.readObject();
